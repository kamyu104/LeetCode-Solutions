...
// [proof]
// - let d = sorted_sums[0]-sorted_sums[1] and d != -d, where one of +d/-d is the smallest positive number or the largest negetive number of the original solution of [S1, ..., S(2^n)]
