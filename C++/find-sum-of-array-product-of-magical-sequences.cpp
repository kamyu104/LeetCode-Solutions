...
public:
    int magicalSum(int m, int k, vector<int>& nums) {
        ...
        vector<vector<vector<int>>> dp(m + 1, vector<vector<int>>(k + 1, vector<int>(m + 1)));  // dp[c][b][l]: sum of carry c with b bits set with size of l
        dp[0][0][0] = 1;
