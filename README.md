...
1030 | [Matrix Cells in Distance Order](https://leetcode.com/problems/matrix-cells-in-distance-order/) | [C++](./C++/matrix-cells-in-distance-order.cpp) [Python](./Python/matrix-cells-in-distance-order.py) | _O(n)_ | _O(1)_      | Easy         ||
...
1032 |[Stream of Characters](https://leetcode.com/problems/stream-of-character/)| [C++](./C++/stream-of-character.cpp) [Python](./Python/stream-of-character.py)| ctor: _O(n)_ <br> query: _O(m + z)_ | _O(t)_ | Hard || `Aho–Corasick Automata`, Trie |
