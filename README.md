...
715| [Range Module](https://leetcode.com/problems/range-module/) | [C++](./C++/range-module.cpp) [Python](./Python/range-module.py) | add: _O(n)_, remove: _O(n)_, query: _O(logn)_ | _O(n)_ | Hard || |
